...
/**
 * The Movable interface defines an object that has a position,
...
public interface Movable {
    ...
    /**
     * @return the velocity of the Movable object
     */
    ...
    /**
     * @return void
     * cause the Movable object to move
     */
    public void move();
     ...
     * @return void
     * 
     * Causes the Movable object to stop; While the implementation of this
     ...
     * @return void
     * 
     * Causes the Movable object to accelerate, i.e. increase the velocity  
     ...
     * velocity.
     * 
     * Causes the Movable object accelerate in both the x (horizontal) and y 
